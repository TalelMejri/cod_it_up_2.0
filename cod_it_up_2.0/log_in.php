         ...
         if(isset($_GET['error'])){
            ...
            <?php echo $_GET['error']; ?>
             <?php }?>
                    ...
                    <div class="rester">
                        <input type="checkbox" name="" id="savePassword">
                        <label for="savePassword">Rester Connecté ?</label>
                        <span><a href="reset.php">forgot Password</a> </span>
                    </div>
                    <div class="btn">
                        <button type="submit" class="send" >Send</button>
                        <button style="background:blue;"  type="create" ><a style="color:#fff;text-decoration:none;" href="sign_up.php">Create Compte</a></button>
                    </div>
                </div>
            </div>
        </form>
